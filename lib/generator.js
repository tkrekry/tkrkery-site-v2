...
function generator(hostname, extraMetadata) {
  return new Metalsmith(sourcePath)
    ...
    .use((files, ms, done) => {
      Object.keys(files).forEach(function (file) {
        ...
        files[file].advertisementPath =
          metalsmithDynamicPages.advertisementPath;
    ...
    .use(
      metalsmithFeed({
        ...
        description:
          "Lääkärien ja hammaslääkärien avoimet työpaikat terveyskeskuksissa",
        site_url: hostname,
